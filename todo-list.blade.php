<div>
    <div class="sm:flex space-y-4 sm:space-y-0 sm:gap-5 justify-between items-center">
        ...
        <div>
            <x-text-input id="search" class="w-full sm:w-72" type="text" name="search" autofocus autocomplete="search"
        ...
        <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 flex flex-col justify-between">
            <div class="flex items-start justify-between">
                <div class="flex items-start flex-grow gap-4">
                    ...
                    <div class="w-full">
                        <x-text-input id="title" class="w-full" type="text" required autofocus
                            autocomplete="title" />
                    ...
                    <div>
                        <h2
                            class="text-lg font-medium text-gray-900 dark:text-gray-100 line-through text-gray-400 dark:text-gray-500">
                            Title
                        </h2>
